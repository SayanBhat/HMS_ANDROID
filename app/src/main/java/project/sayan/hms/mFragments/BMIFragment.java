...
public class BMIFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.bmi_fragment_layout, container,false);
        ...
        sp= getActivity().getSharedPreferences("Login Credentials", Context.MODE_PRIVATE);
        ...
        save_result.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(loginStatus){
                    ...
                    Toast.makeText(getContext(),"Please Sign In to save your result",Toast.LENGTH_SHORT).show();
            }
        });
